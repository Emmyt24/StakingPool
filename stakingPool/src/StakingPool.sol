...
contract StakingPool {
    ...
    error Staking__UserExistInList();
    ...
    function stake(
        ...
        for (uint256 i = 0; i < listOfStakers.length; i++) {
            if (msg.sender == listOfStakers[i]) {
                revert Staking__UserExistInList();
            }
